...
(function(ROOT, struct, undefined){
    ...
    each("X Y ".split(" "),function(name){
        ...
        TRANSITION['scroll'+name]=function(cpage,cp,tpage,tp){
            ...
            transform?cpage.style[transform]='translate'+prop+'('+cp*990+'px)'+fire3D:cpage.style[XY[prop]]=cp*990+'px';
            if(tpage){
                transform?tpage.style[transform]='translate'+prop+'('+tp*990+'px)'+fire3D:tpage.style[XY[prop]]=tp*990+'px';
            }
        }
    ...
    struct.prototype={
        ...
        init:function(config){
            ...
            //滚动条在Y轴上的滚动距离
                ...
                function sccrooo() {
                    setTimeout(function() {
                        offListener(self.container, 'mousewheel DOMMouseScroll' ,sccrooo)
            ...
            addListener(this.container, 'mousewheel DOMMouseScroll' , sccrooo);
